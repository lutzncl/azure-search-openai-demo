...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--openaideployment",
        help="Name of the Azure OpenAI model deployment for an embedding model ('text-embedding-3-small' recommended)",
    )
    parser.add_argument(
        "--openaimodelname", help="Name of the Azure OpenAI embedding model ('text-embedding-3-small' recommended)"
    )
    parser.add_argument(
        "--novectors",
        action="store_true",
